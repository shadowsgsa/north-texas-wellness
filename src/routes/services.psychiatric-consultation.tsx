...
export const Route = createFileRoute("/services/psychiatric-consultation")({
  head: () => ({
    meta: [
      { title: "Psychiatric Consultation — Behavioral Health North Texas" },
      { name: "description", content: "Comprehensive psychiatric evaluation, diagnosis, and medication management with Dr. Bushra Aziz, MD in Garland, TX." },
      { property: "og:title", content: "Psychiatric Consultation — Behavioral Health North Texas" },
      { property: "og:description", content: "Personalized psychiatric care for adults across North Texas." },
    ],
  }),
  component: () => (
    <ServicePage
