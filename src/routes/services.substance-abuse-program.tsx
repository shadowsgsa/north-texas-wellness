...
export const Route = createFileRoute("/services/substance-abuse-program")({
  head: () => ({
    meta: [
      { title: "Substance Abuse Program — Behavioral Health North Texas" },
      { name: "description", content: "Confidential, evidence-based substance use treatment with compassion and dignity in Garland, TX." },
      { property: "og:title", content: "Substance Abuse Program — Behavioral Health North Texas" },
      { property: "og:description", content: "Recovery-focused care for substance use disorders — judgment-free and personalized." },
    ],
  }),
  component: () => (
    <ServicePage
