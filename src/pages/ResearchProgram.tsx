...
export default function ResearchProgram() {
  return (
    <>
      <Helmet>
        <title>Research Program — Behavioral Health North Texas</title>
        <meta name="description" content="Join ethically-conducted clinical research advancing mental health treatment in North Texas." />
      </Helmet>
      <ServicePage
        icon={FlaskConical}
